    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('received', 'Received'), ('shortlisted', 'Shortlisted'), ('onhold', 'On-hold'), ('hired', 'Hired'), ('rejected', 'Rejected')], default='received', max_length=200, verbose_name='Status')),
