...
class Referral(models.Model):
    ...
    role = models.ForeignKey(
        'Role', on_delete=models.SET_NULL, null=True, verbose_name=_("Role")
    )
...
class ReferralStatusLog(models.Model):
    referral = models.ForeignKey(
        Referral, on_delete=models.CASCADE, related_name='status_logs', verbose_name=_("Referral")
    )
    updated_by = models.ForeignKey(
        settings.AUTH_USER_MODEL, on_delete=models.SET_NULL, null=True, verbose_name=_("Updated By")
    )
